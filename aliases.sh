...
alias learning='cd /c/Users/farid/Farid/Web\ development/learning'
alias laravelinit='cd /c/Users/farid/Farid/Resources/ && ./laravelinit.bat && exit'
...
alias gbgd='local res=$(git branch -vv'
alias gbgD='local res=$(git branch -vv'
...
alias pad='php artisan dump-server'
